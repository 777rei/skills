...
function buildCoverR6(config) {
  ...
  for (const line of (config.metaLines || [])) {
    ...
    children.push(new Paragraph({
      ...
      children: [
        new TextRun({ text: label, size: 22, color: P.metaColor || "9A9A9A",
          font: { ascii: "FreeSerif", eastAsia: "Noto Sans SC" }, characterSpacing: 20 }),
        ...(value ? [
          new TextRun({ text: "\t" }),
          new TextRun({ text: value, size: 24, color: P.subtitleColor || "6B6B6B",
            font: { ascii: "FreeSerif", eastAsia: "Noto Sans SC" }, characterSpacing: 8 }),
        ] : []),
      ],
    }));
  }
        ...
        new TableCell({
          ...
          children: [new Paragraph({
            ...
            children: [new TextRun({ text: footerLeft, size: flSize,
              color: P.footerColor || "9A9A9A",
              font: { ascii: "FreeSerif" }, characterSpacing: flSpacing })],
          })],
        }),
        new TableCell({
          ...
          children: [new Paragraph({
            ...
            children: [new TextRun({ text: footerRight, size: 18,
              color: P.footerColor || "9A9A9A",
              font: { ascii: "FreeSerif" }, characterSpacing: 20 })],
          })],
        }),
      ],
    })],
...
function buildCoverR7(config) {
  ...
  children.push(new Paragraph({
    ...
    children: [new TextRun({
      ...
      font: { ascii: "Liberation Sans", eastAsia: "Noto Sans SC" },
    })],
  }));
