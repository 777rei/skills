...
- Reliable CJK rendering (with Noto Sans SC font configured)
...
# ── CJK Font ──
_FONT_PATHS = [
    "/System/Library/Fonts/Supplemental/NotoSansSC[wght].ttf",       # macOS
    "/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc",       # Linux
    "/usr/share/fonts/truetype/chinese/NotoSansSC[wght].ttf",        # custom install
    "./NotoSansSC[wght].ttf",                                         # current dir
]
ZH_FONT = None
...
3. **CJK text**: Must configure Noto Sans SC font; otherwise renders as boxes
