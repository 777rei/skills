...
# ═══ Chinese Font Setup ═══
# Noto Sans SC is the default; other fonts available:
#   NotoSerifSC-Regular.ttf (Songti, formal docs), LXGWWenKai-Regular.ttf (Kaiti, artistic),
#   SarasaMonoSC-*.ttf (monospace CJK, code scenes)
# Run `fc-list :lang=zh` for system fonts (Noto Sans SC, etc.)
# Font path: adjust for your system. Common locations:
#   macOS: '/System/Library/Fonts/Supplemental/NotoSansSC[wght].ttf'
#   Linux: '/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc'
#   Custom: './fonts/NotoSansSC[wght].ttf'
import os
NOTO_SANS_SC_PATH = os.environ.get('NOTO_SANS_SC_FONT', '/System/Library/Fonts/Supplemental/NotoSansSC[wght].ttf')
matplotlib.font_manager.fontManager.addfont(NOTO_SANS_SC_PATH)
